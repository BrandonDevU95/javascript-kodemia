...
// console.log(getProtagonistsList(movies));

// 4. Obtener uan lista de clasificaciones (rating) sin repetir

const getRatingsList = (movies) => {
    return movies.reduce((acc, movie) => {
